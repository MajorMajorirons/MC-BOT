...
Write-Host "========================================"
Write-Host " PersonalPVP Build Script"
Write-Host "========================================"
...
# --- Copy JAR ---
$srcJar = Join-Path $PSScriptRoot "target\PersonalPVP.jar"
$dstDir = Join-Path $PSScriptRoot "..\plugins"
$dstJar = Join-Path $dstDir "PersonalPVP.jar"

if (-not (Test-Path $dstDir)) {
    New-Item -ItemType Directory -Force -Path $dstDir | Out-Null
}

Write-Host "[2/2] Copying to plugins\PersonalPVP.jar..."
Copy-Item -Path $srcJar -Destination $dstJar -Force
Write-Host "  Done!"

Write-Host ""
Write-Host "========================================"
Write-Host " Build complete! plugins\PersonalPVP.jar updated."
